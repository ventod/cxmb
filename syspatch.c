...
unsigned int getMagic(void)
{
	...
	if (fw_version == FW_371)
		...
		magic = 0xDEAD0500;
	else if (fw_version == FW_502 || fw_version == FW_503)
		magic = 0xDEAD0502;
...
unsigned int getFindDriverAddr(void)
{
	...
	else if (fw_version == FW_500 || fw_version == FW_502 || fw_version == FW_503 || fw_version == FW_550)
		addr = pMod->text_addr + 0x00002838;
	else if (fw_version == FW_620 || fw_version == FW_631)
		addr = pMod->text_addr + 0x00002A38;
	else if (fw_version == FW_635 || fw_version == FW_637 || fw_version == FW_638 || fw_version == FW_639)
...
unsigned int getSysconfOffset(void)
{
	...
	if (fw_version == FW_371)
		...
		offset = 0x00007708;
	else if (fw_version == FW_500 || fw_version == FW_502 || fw_version == FW_503)
		offset = 0x00026050;
	else if (fw_version == FW_550)
		offset = 0x000257B8;
	else if (fw_version == FW_620)
		offset = 0x0002BDB4;
	else if (fw_version == FW_631 || fw_version == FW_635 || fw_version == FW_637 || fw_version == FW_638 || fw_version == FW_639)
		offset = 0x0002C724;
	else if (fw_version == FW_660 || fw_version == FW_661)
